...
function RegisterForm({ closeModal }) {
  ...
  return (
    <div className="bg-white p-6 rounded-xl shadow-lg w-full max-w-md relative">
      ...
      <h2 className="text-4xl font-bold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent mb-4">TrueHabitat</h2>
    ...
    <div>
      <nav className="fixed top-0 w-full flex justify-between items-center px-6 py-4 bg-black/40 backdrop-blur-md z-50">
        <div className="flex items-center space-x-2">
          <span className="text-white text-xl font-bold">TrueHabitat</span>
        </div>
